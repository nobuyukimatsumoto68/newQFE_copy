...
def FixElem(g):
 ...
 # @@@ ABS
    ...
    if w < 0:
        s = -1
    elif mp.almosteq(w,0) and x < 0:
        s = -1
    elif w == mp.almosteq(w,0) and x == mp.almosteq(w,0) and y < 0:
        s = -1
    elif w == mp.almosteq(w,0) and x == mp.almosteq(w,0) and y == mp.almosteq(w,0) and z < 0:
        s = -1
...
def GenerateGroup(q):
    ...
    # z_hat = np.array([0.0, 0.0, 1.0], dtype=float64)
